    ...
    <div class="box-body">
        <div class="browser-window">
            ...
            @if ($exception->code || $exception->message)
                <table class="table args" style="margin: 0;">
                    <tbody>
                    <tr>
            ...
            @foreach($frames as $index => $frame)
                <div data-toggle="collapse" data-target="#frame-{{ $index }}" style="border-top: 2px #fff solid;padding: 10px 0 10px 20px; background-color: #f3f3f3">
                ...
                <div class="window-content collapse {{ $index == 0 ? 'in' : '' }}" id="frame-{{ $index }}">
                    ...
                    <table class="table args" style="background-color: #FFFFFF; margin: 10px 0 0 0;">
                        <tbody>
